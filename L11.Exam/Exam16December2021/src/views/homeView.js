    ...
    <section class="welcomePage">
        ...
        <div id="events">
            ...
            <div class="theaters-container">
                ...
                ${theaters.length > 0
                ? theaters.map(theater => cardTemplate(theater))
    ...
    <div class="eventsInfo">
        ...
        <div class="info">
            ...
            <div class="info-buttons">
                <a class="btn-details" href="/data/theaters/${theater._id}">Details</a>
            </div>
        </div>
    </div>
`;
...
export const homeView = (ctx) => {
    requestService.getAllTheaters()
        .then(theaters => ctx.render(homeTemplate(theaters)));
}